...
public class EmployeeChild extends PersonAbstract implements IAppraisable {
	// access modifiers
		...
		public EmployeeChild(int empId, String name, int age, String gender, String designation, String department, double salary) {
		...
		public boolean equals(Object obj) {
			if (obj instanceof EmployeeChild) {
				return this.getEmpId() == ((EmployeeChild) obj).getEmpId();
			}
			return false;
		}
